...
inputs = merge(
  include.envcommon.inputs,
  {
    ...
    private_subnet_tags = merge(
      ...
      {
        "kubernetes.io/cluster/prod-euc2-eks-main"       = "owned"
        "kubernetes.io/cluster/prod-euc2-eks-monitoring" = "shared"
    ...
    private_inbound_acl_rules = [
      # Allow HTTP/HTTPS from public subnets
      {
        ...
        from_port   = 80
        to_port     = 80
        cidr_block  = "10.60.1.0/24" # Public subnet 1
      },
      {
        rule_number = 101
        protocol    = "tcp"
        ...
        from_port   = 80
        to_port     = 80
        cidr_block  = "10.60.2.0/24" # Public subnet 2
      },
      {
        rule_number = 102
        protocol    = "tcp"
        ...
        from_port   = 80
        to_port     = 80
        cidr_block  = "10.60.3.0/24" # Public subnet 3
      },
      {
        rule_number = 110
        protocol    = "tcp"
      ...
      # Allow internal VPC communication
      {
        ...
        from_port   = 0
        to_port     = 65535
        cidr_block  = "10.60.0.0/16" # Entire VPC
      },
      {
        rule_number = 210
        protocol    = "udp"
    ...
    database_inbound_acl_rules = [
      # PostgreSQL from private subnets only
      {
        ...
        from_port   = 5432
        to_port     = 5432
        cidr_block  = "10.60.11.0/24" # Private subnet 1
      },
      {
        rule_number = 101
        protocol    = "tcp"
        ...
        from_port   = 5432
        to_port     = 5432
        cidr_block  = "10.60.12.0/24" # Private subnet 2
      },
      {
        rule_number = 102
        protocol    = "tcp"
        ...
        from_port   = 5432
        to_port     = 5432
        cidr_block  = "10.60.13.0/24" # Private subnet 3
      },
