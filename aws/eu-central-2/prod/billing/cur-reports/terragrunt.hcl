# =============================================================================
# PRODUCTION COST AND USAGE REPORTS (CUR) - EU-CENTRAL-2
# =============================================================================
...
locals {
  ...
  report_name = "yov-cur-prod-euc2"
  bucket_name = "yov-cur-reports-025066254478-eu-central-2"
}
...
inputs = {
  ...
  tags = {
    ...
    CostCenter          = "PROD-BILLING-002"
    BudgetMonitoring    = "enabled"
    AlertRecipients     = "finance-alerts@yov.com"
    
    # Analytics and reporting
    AthenaWorkgroup     = "cur-analytics-eu"
    RedshiftCluster     = "billing-analytics-eu"
    DashboardUrl        = "billing.yov.com/prod-eu"
