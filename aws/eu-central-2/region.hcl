...
locals {
  ...
  regional_networking = {
    ...
    vpc_cidrs = {
      ...
      staging = "10.50.0.0/16"  # 10.50.0.0 - 10.50.255.255 (65,536 IPs)
      prod = "10.60.0.0/16"     # 10.60.0.0 - 10.60.255.255 (65,536 IPs)
    }
    ...
    subnet_strategy = {
      public_subnets = {
        ...
        staging = ["10.50.1.0/24", "10.50.2.0/24", "10.50.3.0/24"]
        prod = ["10.60.1.0/24", "10.60.2.0/24", "10.60.3.0/24"]
      }
      private_subnets = {
        dev = ["10.40.11.0/24", "10.40.12.0/24", "10.40.13.0/24"]
        staging = ["10.50.11.0/24", "10.50.12.0/24", "10.50.13.0/24"]
        prod = ["10.60.11.0/24", "10.60.12.0/24", "10.60.13.0/24"]
      }
      database_subnets = {
        dev = ["10.40.21.0/24", "10.40.22.0/24", "10.40.23.0/24"]
        staging = ["10.50.21.0/24", "10.50.22.0/24", "10.50.23.0/24"]
        prod = ["10.60.21.0/24", "10.60.22.0/24", "10.60.23.0/24"]
      }
      intra_subnets = {
        dev = ["10.40.31.0/24", "10.40.32.0/24", "10.40.33.0/24"]
        staging = ["10.50.31.0/24", "10.50.32.0/24", "10.50.33.0/24"]
        prod = ["10.60.31.0/24", "10.60.32.0/24", "10.60.33.0/24"]
      }
    }
  }
