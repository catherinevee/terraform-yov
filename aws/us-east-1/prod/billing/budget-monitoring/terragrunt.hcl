# =============================================================================
# PRODUCTION AWS BUDGETS - US-EAST-1
# =============================================================================
...
locals {
  ...
  budget_name = "yov-budget-prod-use1"
}
...
inputs = {
  ...
  budget_type  = "COST"
  limit_amount = "2000"  # $2000/month for production
  limit_unit   = "USD"
  time_unit    = "MONTHLY"
  ...
  tags = {
    ...
    EscalationPolicy    = "finance-ops-exec"
